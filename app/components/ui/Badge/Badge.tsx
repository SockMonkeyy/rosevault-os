...
export default function AddPropertyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F6] p-8 selection:bg-[#D8B66A]/30">
      <div className="mx-auto max-w-5xl">
        {/* Header */}
        <div className="mb-10">
          <Link
            href="/properties"
            className="mb-4 inline-flex items-center text-xs font-semibold uppercase tracking-[0.16em] text-[#B7832F] transition hover:text-[#D8B66A]"
          >
            ← Back to Properties
          </Link>

          <h1 className="font-serif text-3xl font-normal text-[#B7832F] sm:text-4xl">
            Add New Property
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          >
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-2 text-xs italic text-[#8F8578]">
          ...
          {/* Error Container */}
          {errorMessage && (
            <div className="rounded-xl border border-red-200 bg-red-50/70 px-5 py-4 text-sm text-red-800 backdrop-blur-sm">
              {errorMessage}
            </div>
          )}
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-[#EDE7DC] pt-6 sm:flex-row sm:justify-end">
            <Link
              href="/properties"
              className="rounded-lg border border-[#EDE7DC] bg-white/60 px-5 py-3 text-center text-sm font-medium text-[#7C7265] transition duration-200 hover:border-[#D8B66A]/40 hover:bg-white hover:text-[#5C544A]"
            >
              Cancel
            </Link>
...
function FormSection({
  ...
  return (
    <section className="rounded-2xl border border-[#EDE7DC] bg-white/45 p-6 backdrop-blur-sm transition-all duration-300 hover:border-[#D8B66A]/30">
      <div className="mb-6">
  ...
  return (
    <div>
      ...
      <div className="relative">
        <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#8F8578] text-sm">
          $
        </span>
...
// RoseVault Editorial Design Variables
const labelClasses =
  "mb-2 block text-[10px] font-semibold uppercase tracking-[0.16em] text-[#8F8578]";

const inputClasses =
  "w-full rounded-lg border border-[#EDE7DC] bg-white/80 px-4 py-3 text-sm text-[#5C544A] outline-none transition duration-200 placeholder:text-[#CAD1C3]/80 focus:border-[#D8B66A] focus:bg-white focus:ring-1 focus:ring-[#D8B66A]/30 hover:border-[#D8B66A]/40";